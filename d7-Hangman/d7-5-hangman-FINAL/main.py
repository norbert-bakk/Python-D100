...
while not end_of_game:
    ...
    if guess[0] in used_letters:
        print(f"You've already tried the {guess[0]} letter!")
    else:
        ...
        for position in range(word_length):
            ...
            if letter == guess[0]:
                ...
                used_letters += guess[0]
    
    if guess[0] in used_letters:
        print("No life was taken away from you!")
    else:
        #Check if user is wrong.
        if guess[0] not in chosen_word:
            #TODO-5: - If the letter is not in the chosen_word, print out the letter and 
            #let them know it's not in the word.
            lives -= 1
            used_letters += guess[0]
            print(f"The {guess[0]} is not in word. You've lost 1 life.")
            if lives == 0:
                end_of_game = True
                print("You lose.")
